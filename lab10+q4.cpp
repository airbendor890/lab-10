...
class rectangle{
		...
		int X2;int Y2;
		int X3;int Y3;
		int X4;int Y4;//top right point
		int side1();	//calculating side length
		int side2();
...
//Lab 7 Exercises 4.2, 4.3. Testing of the class Rectangle goes here:  
	rectangle rect1;// Declaring a rectangle  using default class constructor
	rectangle rect2(1,1,5,6);// Declaring a rectangle  using parametraized class constructor
